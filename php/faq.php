...
<body>
   <?= $nav ?>
    ...
    <div class="container d-flex flex-row justify-content-evenly flex-wrap flex-sm-wrap flex-md-wrap flex-lg-nowrap flex-xl-nowrap flex-xxl-nowrapgap-5">
        <div class="mt-5 ">
            <div class="mb-3 mt-5">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq1" aria-expanded="false" aria-controls="faq1" >
                    What is Pawfect? 
                    <img src="../images/arrow_down.png" class="ms-3" style="height: 2vh;">
                </button>
                <div class="collapse" id="faq1">
                    <div class="card card-body faqCard"  style="width: 30vw;">
                        The goal of Pawfect is to connect animal shelters with potential adopters and help our pet friends to find a new home. 
                    </div>
                </div>
            </div>
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq5" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq6" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq7" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq8" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq9" aria-expanded="false" aria-controls="faq1" >
            ...
            <div class="mb-3">
                <button class="btn btn-secondary p-3 text-start d-flex justify-content-between mb-3" style="width: 30vw;" type="button" data-bs-toggle="collapse" data-bs-target="#faq10" aria-expanded="false" aria-controls="faq1">
        ...
        <div class="mt-5">
            <div class="card card-body mt-5 rounded-4 faqCard" style="width: 20vw;">
